...
| Delta-FP8 FSDP2 Param AllGather | `--fsdp-delta-fp8-allgather` | `False` | Bool flag | Compress BF16 FSDP2 AllGather deltas into blockwise FP8; see the [usage guide](../features/delta_fp8_allgather.md) |
...
Delta-FP8 changes only FSDP parameter communication precision; model computation remains in the dtype selected by the FSDP mixed-precision policy. See [Delta-FP8 FSDP2 Param AllGather](../features/delta_fp8_allgather.md) for prerequisites, usage, parameter reference, and troubleshooting.
