...
"""FastWAM IDM model with teacher-forcing video conditioning."""
...
class FastWAMIDM(FastWAMJoint):
    ...
    def infer_action(
        ...
        """Infer an action sequence from an input image and prompt or encoded context."""
    ...
    def infer_joint(
        ...
        """Infer video and action with video-first IDM sampling."""
